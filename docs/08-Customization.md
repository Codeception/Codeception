...
Currently these steps decorators are included by default:
...
A class should provide `getTemplate` method which returns a template with code block and variables passed into it. 
