...
Your custom commands have to implement the interface Codeception\Lib\Interfaces\CustomCommands,
...
You can find an example here:  [src/Codeception/Command/MyCustomCommand.php]
