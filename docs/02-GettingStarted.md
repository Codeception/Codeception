...
## Tests
Codeception supports three test formats. Besides the previously described hybrid Cept format, Codeception can also execute PHPUnit test files for unit testing. There is no difference in the way the tests of either format will be run in the suite. But within the PHPUnit tests you can't use Guy classes. 
