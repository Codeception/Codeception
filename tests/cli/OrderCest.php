...
class OrderCest
{
    ...
    public function checkForCanCantFails(CliGuy $I)
    {
        ...
        $I->seeFileFound('order.txt', 'tests/_output');
        $I->expect(
            'global bootstrap, initialization, beforeSuite, before, bootstrap, '.
            'test, fail, fail, test, after, afterSuite'
        );
    ...
    public function checkForCanCantFailsInCest(CliGuy $I)
    {
        ...
        $I->expect(
            'global bootstrap, initialization, beforeSuite, before, bootstrap, '.
            'test, fail, fail, test, test, fail, fail, test, after, afterSuite'
        );
