...
final class RetryCest
{
    ...
    public function checkTheTestsPassesOn3rdRetry(CliTester $I)
    {
    ...
    public function checkThatRetryHappensOnSpecificInterval(CliTester $I)
    {
    ...
    public function checkTheTestFailsEvenAfterRetries(CliTester $I)
    {
    ...
    public function checkTheTestFailsEvenWhenRetriesByInterval(CliTester $I)
    {
    ...
    public function checkThatTryToWontFailTest(CliTester $I)
    {
