...
CREATE TABLE "groups" ("id" INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , "name" VARCHAR, "created_at" DATETIME DEFAULT CURRENT_TIMESTAMP);
INSERT INTO "groups" VALUES(1,'coders','2012-02-01 21:17:50');
INSERT INTO "groups" VALUES(2,'jazzman','2012-02-01 21:18:40');
