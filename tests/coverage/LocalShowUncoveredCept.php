...
$I->executeCommand('run math_show_uncovered MathCest:testAddition --coverage', null, '-d pcov.directory=' . getcwd());
...
$I->executeCommand('run math MathCest:testAddition --coverage', null, '-d pcov.directory=' . getcwd());
$I->seeInShellOutput('OK (1 test');
