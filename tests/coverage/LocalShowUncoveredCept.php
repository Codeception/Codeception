...
$I->executeCommand('run math2_show_uncovered Math2ShowUncoveredCest:testAddition --coverage', null, '-d pcov.directory=' . getcwd());
...
$I->executeCommand('run math2 Math2Cest:testAddition --coverage', null, '-d pcov.directory=' . getcwd());
$I->seeInShellOutput('OK (1 test');
