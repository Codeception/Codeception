...
class DbTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        self::$module->_before(\Codeception\Util\Stub::makeEmpty('\Codeception\TestCase'));
        ...
        self::$module->_after(\Codeception\Util\Stub::makeEmpty('\Codeception\TestCase'));
    ...
    {
        $testCase1 = \Codeception\Util\Stub::makeEmpty('\Codeception\TestCase');
        $testCase2 = \Codeception\Util\Stub::makeEmpty('\Codeception\TestCase');
